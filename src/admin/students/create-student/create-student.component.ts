import { EventEmitter,Component, OnInit,Injector, Output } from '@angular/core';
...
@Output() onSave=new EventEmitter<any>();
  ...
  imageFile: string;
    constructor(public commonService: CommonServiceServiceProxy, injector:Injector,public bsModalRef:BsModalRef,private _userService:UserServiceProxy, private _apiService: AppSessionService) { super(injector)}
